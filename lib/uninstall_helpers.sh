...
uninstall_pre_commit() {
  ...
  _rm_path file "$project_path/.git/hooks/depcheck.py" ".git/hooks/depcheck.py"
  _rm_path file "$project_path/.git/hooks/coverage_probe.py" ".git/hooks/coverage_probe.py"
