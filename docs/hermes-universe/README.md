...
> 상태: **설계 단계(구현 전).** 큰 주제 4건 중 Q-1(에이전트 생성) · Q-2(인계 계약) · Q-3(기존 자산 정리) · Q-4(복사 설치 예외) **모두 완료.** 2026-09-15 리뷰에서 빈틈 12건과 cumora 교훈 9건을 설계 문서에 넣었고, 사용자 위임으로 17건 전부 **확정(위임)** 했다([decision-log.md](decision-log.md) 12절 RV-01~17, 근거 [docs/audits/2026-09-15-hermes-universe-design-review.md](../audits/2026-09-15-hermes-universe-design-review.md)). 다음은 실측 항목(V-1~V-6, V-8) 확인 → 실행 계획 작성(순서는 G-24: 복사 설치 전환이 먼저).
...
| 스킬 | 우주 공통 · 소우주 공통 · 조직 단위 · 개인 4층, 위아래 양방향 이동 | 확정 |
...
| 제안 배달 | 소우주 보낼 편지함에 쓰고 공장 GitHub 이슈로만 배달. 로컬 배달 금지 | 확정 |
...
| 조직 정의 | 틀은 하나: 직군 · 수직 · 수평 세 축. 축의 종류와 "사람이 맨 위"는 공장이 고정, 값은 각 소우주가 정의 | 확정 |
