...
### With planner agent
The planner should invoke a general-purpose research agent before Phase 1 (Architecture Review):
- The research agent identifies available tools
- Planner incorporates them into the implementation plan
- Avoids "reinventing the wheel" in the plan

### With architect agent
The architect should consult a general-purpose research agent for:
