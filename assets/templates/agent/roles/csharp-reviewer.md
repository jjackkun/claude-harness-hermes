...
source_path: agents/csharp-reviewer.md
...
discipline_hint: QA
---
# csharp-reviewer (역할 템플릿)

> 출처 ECC@934195f `agents/csharp-reviewer.md` (MIT). 규칙 변환 — 본문은 영어 원문. `hire --template csharp-reviewer` 이 SOUL 초안에 넣는다.
