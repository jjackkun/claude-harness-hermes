...
source_path: agents/harmonyos-app-resolver.md
...
discipline_hint: 백엔드
---
# harmonyos-app-resolver (역할 템플릿)

> 출처 ECC@934195f `agents/harmonyos-app-resolver.md` (MIT). 규칙 변환 — 본문은 영어 원문. `hire --template harmonyos-app-resolver` 이 SOUL 초안에 넣는다.
