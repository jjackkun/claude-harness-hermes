...
source_path: agents/homelab-architect.md
...
discipline_hint: 백엔드
---
# homelab-architect (역할 템플릿)

> 출처 ECC@934195f `agents/homelab-architect.md` (MIT). 규칙 변환 — 본문은 영어 원문. `hire --template homelab-architect` 이 SOUL 초안에 넣는다.
