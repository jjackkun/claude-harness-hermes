...
> 출처 ECC@934195f `agents/docs-lookup.md` (MIT). 규칙 변환 — 본문은 영어 원문. `hire --template docs-lookup` 이 SOUL 초안에 넣는다.
...
## 도구
- tools: Read, Grep, mcp__context7__resolve-library-id, mcp__context7__query-docs · model: haiku
