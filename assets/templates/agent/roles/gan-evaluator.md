...
source_path: agents/gan-evaluator.md
...
discipline_hint: QA
---
# gan-evaluator (역할 템플릿)

> 출처 ECC@934195f `agents/gan-evaluator.md` (MIT). 규칙 변환 — 본문은 영어 원문. `hire --template gan-evaluator` 이 SOUL 초안에 넣는다.
...
## 도구
- tools: Read, Write, Bash, Grep, Glob, mcp__playwright__browser_navigate, mcp__playwright__browser_click, mcp__playwright__browser_take_screenshot, mcp__playwright__browser_snapshot, mcp__playwright__browser_type, mcp__playwright__browser_fill_form · model: sonnet
