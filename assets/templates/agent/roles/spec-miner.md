...
source_path: agents/spec-miner.md
...
> 출처 ECC@934195f `agents/spec-miner.md` (MIT). 규칙 변환 — 본문은 영어 원문. `hire --template spec-miner` 이 SOUL 초안에 넣는다.
...
## 도구
- tools: Read, Grep, Glob, Bash, Write · model: opus
