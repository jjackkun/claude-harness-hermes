...
source_path: agents/swift-build-resolver.md
...
discipline_hint: 백엔드
---
# swift-build-resolver (역할 템플릿)

> 출처 ECC@934195f `agents/swift-build-resolver.md` (MIT). 규칙 변환 — 본문은 영어 원문. `hire --template swift-build-resolver` 이 SOUL 초안에 넣는다.
