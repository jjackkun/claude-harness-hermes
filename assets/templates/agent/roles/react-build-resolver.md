...
source_path: agents/react-build-resolver.md
...
discipline_hint: 백엔드
---
# react-build-resolver (역할 템플릿)

> 출처 ECC@934195f `agents/react-build-resolver.md` (MIT). 규칙 변환 — 본문은 영어 원문. `hire --template react-build-resolver` 이 SOUL 초안에 넣는다.
