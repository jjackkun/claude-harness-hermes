...
source_path: agents/performance-optimizer.md
...
discipline_hint: 백엔드
---
# performance-optimizer (역할 템플릿)

> 출처 ECC@934195f `agents/performance-optimizer.md` (MIT). 규칙 변환 — 본문은 영어 원문. `hire --template performance-optimizer` 이 SOUL 초안에 넣는다.
