...
source_path: agents/swift-reviewer.md
...
discipline_hint: QA
---
# swift-reviewer (역할 템플릿)

> 출처 ECC@934195f `agents/swift-reviewer.md` (MIT). 규칙 변환 — 본문은 영어 원문. `hire --template swift-reviewer` 이 SOUL 초안에 넣는다.
