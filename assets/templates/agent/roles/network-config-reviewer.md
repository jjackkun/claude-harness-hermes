...
source_path: agents/network-config-reviewer.md
...
discipline_hint: QA
---
# network-config-reviewer (역할 템플릿)

> 출처 ECC@934195f `agents/network-config-reviewer.md` (MIT). 규칙 변환 — 본문은 영어 원문. `hire --template network-config-reviewer` 이 SOUL 초안에 넣는다.
