...
source_path: agents/opensource-forker.md
...
---
# opensource-forker (역할 템플릿)

> 출처 ECC@934195f `agents/opensource-forker.md` (MIT). 규칙 변환 — 본문은 영어 원문. `hire --template opensource-forker` 이 SOUL 초안에 넣는다.
