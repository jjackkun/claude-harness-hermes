...
source_path: agents/rag-pipeline-reviewer.md
...
discipline_hint: QA
---
# rag-pipeline-reviewer (역할 템플릿)

> 출처 ECC@934195f `agents/rag-pipeline-reviewer.md` (MIT). 규칙 변환 — 본문은 영어 원문. `hire --template rag-pipeline-reviewer` 이 SOUL 초안에 넣는다.
