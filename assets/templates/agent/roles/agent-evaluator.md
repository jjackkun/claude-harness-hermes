...
source_path: agents/agent-evaluator.md
...
discipline_hint: QA
---
# agent-evaluator (역할 템플릿)

> 출처 ECC@934195f `agents/agent-evaluator.md` (MIT). 규칙 변환 — 본문은 영어 원문. `hire --template agent-evaluator` 이 SOUL 초안에 넣는다.
