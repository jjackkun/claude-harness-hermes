...
source_path: agents/comment-analyzer.md
description: Analyze code comments for accuracy, completeness, maintainability, and comment rot risk.
tools: Read, Grep, Glob
model: haiku
discipline_hint: general
---
# comment-analyzer (역할 템플릿)

> 출처 ECC@934195f `agents/comment-analyzer.md` (MIT). 규칙 변환 — 본문은 영어 원문. `hire --template comment-analyzer` 이 SOUL 초안에 넣는다.
