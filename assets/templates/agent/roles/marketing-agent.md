...
source_path: agents/marketing-agent.md
...
discipline_hint: 영업
---
# marketing-agent (역할 템플릿)

> 출처 ECC@934195f `agents/marketing-agent.md` (MIT). 규칙 변환 — 본문은 영어 원문. `hire --template marketing-agent` 이 SOUL 초안에 넣는다.
