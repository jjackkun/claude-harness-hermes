...
source_path: agents/gan-generator.md
...
---
# gan-generator (역할 템플릿)

> 출처 ECC@934195f `agents/gan-generator.md` (MIT). 규칙 변환 — 본문은 영어 원문. `hire --template gan-generator` 이 SOUL 초안에 넣는다.
